...
from .database import retrieve_all_extra_responses, retrieve_all_ques_answers, retrieve_table, add_new_entry, add_new_entry_extra_responses, add_new_entry_ques_answers, retrieve_all_questions, add_new_entry_all_questions
...
class GetSurveyAnswersFromUser:
    ...
    def qna_from_user(self):
        ...
        for i in range(20):
            ...
            if "I got the answer" in answr_agent_reply or "I got my answer" in answr_agent_reply:
    ...
    def get_structured_ques_answers(self, user_name_val): 
        ...
        existing_answers= list(existing_ques_answers)
